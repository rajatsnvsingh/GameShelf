/** Merges provider metadata and manual overrides into display-safe catalog details. */
...
export function displayMetadata(
  ...
  if (
    ...
    (fields.releaseYear as number) > 0
  )
    result.releaseYear = fields.releaseYear as number;
  if (
